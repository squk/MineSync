...
$pPassword = urldecode($_GET['password']);
...
{ 
    ...
    { 
      ...
      $sql = "INSERT INTO users (username, password, email) VALUES ('$eUsername', '" . hashPassword($pPassword) . "', '$pEmail');"; 
...
{ 
  return strtoupper(md5($pPassword . "RANDOMSTRING")); 
} 
