    ...
    public partial class BugForm : Form
    {
        ...
        private void sendButton_Click(object sender, EventArgs e)
        {
            if (capString == captchaBox.Text)
            {
                ...
                {
                    MessageBox.Show("You must have logged into MineSync atleast once to submit a bug report/suggestion");
                }
                else
                {

                    WebClient wc = new WebClient();
                    string uri = "http://URL/report.php";
                    ...
                    {
                        MessageBox.Show("Please fill out all of the fields before sending your request.");
                    }
                    else
                    {
            ...
            {
                MessageBox.Show("The captcha you entered did not match the captcha image.");
            }
        }
    }
}
